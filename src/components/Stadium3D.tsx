...
function Pitch() {
  return (
    <group>
      ...
      {/* lines */}
      {[
        { args: [60, 0.15] as [number, number], pos: [0, 0.01, 0] as [number, number, number] }, // halfway across X
        { args: [0.15, 38] as [number, number], pos: [0, 0.01, 0] as [number, number, number] }, // halfway line
      ].map((l, i) => (
